...
public class GeoRecommendation {
	...
	public List<Item> recommendItems(String userId, double lat, double lon) {
		...
		categoryList.sort((o1, o2) -> Integer.compare(o1.getValue(), o2.getValue()));
...
//				});
		...
		for (Entry<String, Integer> category : categoryList) {
            // auto get the same category's event
			...
			filteredItems.sort((o1, o2) -> Double.compare(o1.getDistance(), o2.getDistance()));
...
//					});
			...
			//相当于一个去重记录器过滤掉同一item可能存在多个category重复搜索的问题
